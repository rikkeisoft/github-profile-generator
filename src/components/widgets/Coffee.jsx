        ...
        <div className="w-80 h-80 p-6 pb-16 fixed bottom-20 right-6 z-10 bg-white overflow-y-scroll rounded-xl shadow-2xl flex flex-col justify-items-center">
          ...
          <div className="p-3 rounded-md flex justify-items-center items-center border-2 border-red-300 bg-red-100 mb-4">
            ...
            <div className="flex justify-items-center items-center">
              <p className="ml-2 border flex items-center justify-items-center p-2.5 w-8 h-8 rounded-full border-red-300 bg-white">1</p>
              <p className="ml-2 border flex items-center justify-items-center p-2.5 w-8 h-8 rounded-full border-red-300 bg-white">3</p>
              <p className="ml-2 border flex items-center justify-items-center p-2.5 w-8 h-8 rounded-full border-red-300 bg-white">5</p>
            </div>
            <input
              type="text"
              placeholder={8}
          ...
          <input
            ...
            className="p-3 mb-4 bg-gray-200 rounded-md border focus:border-gray-500 outline-none"
          />
          <button className="py-3 mb-8 rounded-3xl bg-yellow-400 text-white font-medium hover:opacity-90">Support $5</button>
          ...
          >
            <a href="buymeacoffee.com" className="px-10 py-1.5 rounded-3xl text-sm bg-gray-100 text-gray-600 hover:bg-gray-200">buymeacoffee.com</a>
          </div>
        </div>
      }
    </div>
